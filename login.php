    ...
    <header>
        <div id="flu">
            <a class="navbar-brand">
               <a href="index.php"><img src="ShopExpresM.png" alt="ShopExpres" width="150" height="200" class="img-fluid"></a>
        </div>
    </header>
    <main>
        <div class="container">
            ...
            <form id="b" class="needs-validation" novalidate action="process.php" method="post">
                ...
                <div class="d-grid gap-2 col-6 mx-auto">
                    ...
                    <span><a href="cadastro.php" id="bc" class="btn btn-primary btn-lg">Cadastrar</a>
                </div>
                <div>
                    <br>
                    <p>Quero acessar com minhas redes sociais</p>
                    <button type="submit" class="btn btn-light" id="bu" class="botaoCOR"> Entrar com o FACEBOOK</button> <button type="submit" class="btn btn-light" id="em"> Entrar com o GOOGLE</button>
                </div>
            </form>
